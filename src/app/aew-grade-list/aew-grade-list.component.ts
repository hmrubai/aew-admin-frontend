...
@Component({
    selector: 'app-aew-grade-list',
    templateUrl: './aew-grade-list.component.html',
    encapsulation: ViewEncapsulation.None
})

export class AEWGradeListComponent implements OnInit {
    ...
    getGradeList() {
        this._service.get('admin/grade-list').subscribe(res => {
            if (res.status == false) {
    ...
    onFormSubmit() {
        ...
        this._service.post('admin/grade-save-or-update', obj).subscribe(
            data => {
                this.blockUI.stop();
                if (data.status == true) {
