...
export const AppRoutes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'beat/beat-coaching-center',
        loadChildren: () => import('./beat-coaching-center/beat-coaching-center.module').then(m => m.BEATCoachingCenterModule),
        // canActivate: [AuthGuard]
      },
      {
        path: 'beat/beat-coaching-center-member-list',
        loadChildren: () => import('./beat-coaching-center-member-list/beat-coaching-center-member-list.module').then(m => m.BEATCoachingCenterMemberListModule),
        // canActivate: [AuthGuard]
      },
      {
      ...
      {
        path: 'beat/aew-collaborator-list',
        loadChildren: () => import('./beat-collaborator-info/beat-collaborator-info.module').then(m => m.AEWCollaboratorInfoModule),
        // canActivate: [AuthGuard]
      },
      {
      ...
      {
        path: 'coaching-center-student-list/:id',
        loadChildren: () => import('./coaching-center-student-list/coaching-center-student-list.module').then(m => m.CoachingCenterStudentListModule),
        // canActivate: [AuthGuard]
      },
      {
        path: 'screening-test/screening-test-list',
        loadChildren: () => import('./screening-test/screening-test-list/screening-test-list.module').then(m => m.ScreeningTestListModule),
        // canActivate: [AuthGuard]
      },
      {
        path: 'screening-questions/:id',
        loadChildren: () => import('./screening-test/screening-exam-questions/screening-exam-questions.module').then(m => m.ScreeningExamQuestionsModule),
        // canActivate: [AuthGuard]
      },
      {
        path: 'screening-exam-result/:exam_id',
        loadChildren: () => import('./screening-test/screening-exam-result/screening-exam-result.module').then(m => m.ScreeningExamResultModule),
        // canActivate: [AuthGuard]
      },
      {
        path: 'screening-quota-list/:exam_id',
        loadChildren: () => import('./screening-test/screening-quota-list/screening-quota-list.module').then(m => m.ScreeningQuotaListModule),
        // canActivate: [AuthGuard]
      },*/
      
      /*{ ScreeningTestListModule
        path: 'assesment-subject-wise-participants/:id',
        loadChildren: () => import('./assesment-subject-wise-participants/assesment-subject-wise-participants.module').then(m => m.SubjectWiseParticipantsListModule),
        // canActivate: [AuthGuard]
      },{
