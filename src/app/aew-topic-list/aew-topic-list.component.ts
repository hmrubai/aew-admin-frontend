...
export class AEWTopicListComponent implements OnInit {
    ...
    getItem(item, template: TemplateRef<any>) {
        ...
        this.entryForm.controls['package_type_id'].setValue(item.package_type_id);
        this.entryForm.controls['catagory_id'].setValue(item.catagory_id);
        this.entryForm.controls['grade_id'].setValue(item.grade_id);
